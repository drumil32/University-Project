...
#burj svg { 
 ...
 <!-- End breadcrumb -->
  ...
  <a xlink:href="studentlogin.php">
    <rect x="155" y="280" fill="#fff" opacity="0" width="218" height="90" />
    </a>
    <a xlink:href="teacherlogin.php">
    <rect x="485" y="280" fill="#fff" opacity="0" width="230" height="90" />
    </a>
    <a xlink:href="depart_login.php">
    <rect x="815" y="285" fill="#fff" opacity="0" width="240" height="90" />
    </a>
  </svg>
</figure>
