...
<html lang="en">
  <head>
    ...
    <title>Saint | Administrator Login</title>
    <!-- Favicon -->
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mu-contact-left">
                  <form class="contactform" action="check_depart.php" method="POST">                  
                    <p class="comment-form-author">
                      <label for="author">Username<span class="required">*</span></label>
                      <input type="email" placeholder="Email ID"  name="user_name"  required>
                    </p>
                    <p class="comment-form-email">
                      <label for="email">Password<span class="required">*</span></label>
                      <input type="text" placeholder="Password" maxlength="14" name="password" required>
                    </p>               
                    <p class="form-submit">
                      <input type="submit" value="login" class="mu-post-btn">
                    </p> 
                     <a href="forgot_password.php?sign=0">Forgot Password ?</a>       
                  </form>
                </div>
              </div>
            </div>
